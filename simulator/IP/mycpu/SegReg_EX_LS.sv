module SegReg_EX_LS#(
    ...
    output logic [ 2:0] csr_op_ls,
    output logic [ 0:0] csr_we_ls,
    output logic [11:0] csr_addr_ls,
    output logic [31:0] csr_data_ls
);
    always_ff @(posedge clk) begin
        if(!rstn || flush) begin
            ...
            csr_op_ls       <= csr_op_ex;
            csr_we_ls       <= csr_we_ex;
            csr_addr_ls     <= csr_addr_ex;
            csr_data_ls     <= csr_data_ex;
        end
    end
endmodule