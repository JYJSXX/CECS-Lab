...
void VCPU___024root__trace_chg_sub_0(VCPU___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+66,((((IData)(vlSelf->CPU__DOT__ALU_inst__DOT____VdfgTmp_h1748fad1__0) 
        ...
        bufp->chgBit(oldp+70,(((IData)(vlSelf->CPU__DOT__Branch_inst__DOT____VdfgTmp_h8a52d44e__0) 
                               & ((IData)(vlSelf->CPU__DOT__br_type_ex) 
                                  >> 2U))));
