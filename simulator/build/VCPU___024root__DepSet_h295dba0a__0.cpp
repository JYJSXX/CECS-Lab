...
VL_INLINE_OPT void VCPU___024root___ico_sequent__TOP__0(VCPU___024root* vlSelf) {
    ...
    vlSelf->CPU__DOT__axi_arbiter_inst__DOT__r_nxt 
        = VCPU__ConstPool__TABLE_hb4321f50_0[__Vtableidx3];
    ...
    __Vtableidx5 = (((IData)(vlSelf->bvalid) << 5U) 
                    | (((IData)(vlSelf->CPU__DOT__d_bready) 
                        << 4U) | (((IData)(vlSelf->CPU__DOT__d_wlast) 
                                   << 3U) | (((IData)(vlSelf->wready) 
                                              << 2U) 
                                             | (IData)(vlSelf->CPU__DOT__axi_arbiter_inst__DOT__w_crt)))));
    vlSelf->CPU__DOT__d_wready = VCPU__ConstPool__TABLE_h6cd485ff_0
        [__Vtableidx5];
    vlSelf->CPU__DOT__d_bvalid = VCPU__ConstPool__TABLE_h6d116ef1_0
        [__Vtableidx5];
    vlSelf->bready = VCPU__ConstPool__TABLE_h2b2eec9f_0
        [__Vtableidx5];
    vlSelf->awvalid = VCPU__ConstPool__TABLE_h1327342c_0
        [__Vtableidx5];
    vlSelf->wvalid = VCPU__ConstPool__TABLE_hf483ebd5_0
        [__Vtableidx5];
    vlSelf->wlast = VCPU__ConstPool__TABLE_h185d04da_0
        [__Vtableidx5];
    ...
    vlSelf->CPU__DOT__ICache_inst__DOT__next_state 
        = VCPU__ConstPool__TABLE_h9c271f54_0[__Vtableidx1];
    if ((2U & (IData)(vlSelf->CPU__DOT__DCache_inst__DOT__state))) {
        ...
        } else if (((IData)(vlSelf->CPU__DOT__d_rready) 
                    & (IData)(vlSelf->CPU__DOT__d_rlast))) {
            if ((0xaU == (vlSelf->CPU__DOT__DCache_inst__DOT__addr_pipe 
                          >> 0x1cU))) {
                vlSelf->CPU__DOT__DCache_inst__DOT__next_state = 3U;
            }
            vlSelf->CPU__DOT__DCache_inst__DOT__next_state = 2U;
        } else {
        ...
        vlSelf->CPU__DOT__DCache_inst__DOT__next_state 
            = (((IData)(vlSelf->CPU__DOT__DCache_inst__DOT__rvalid_pipe) 
                ...
                ? (((0xaU == (vlSelf->CPU__DOT__DCache_inst__DOT__addr_pipe 
                    ...
                    ? 1U : (((0xaU == (vlSelf->CPU__DOT__DCache_inst__DOT__addr_pipe 
                                       >> 0x1cU)) & (IData)(vlSelf->CPU__DOT__DCache_inst__DOT__wvalid_pipe))
                             ? 3U : ((0U != (IData)(vlSelf->CPU__DOT__DCache_inst__DOT__hit))
                                      ? 0U : 1U))) : 
               ((IData)(vlSelf->CPU__DOT__DCache_inst__DOT__fence_valid_pipe)
                 ? 1U : 0U));
    }
    ...
    vlSelf->CPU__DOT__axi_arbiter_inst__DOT__w_nxt 
        = VCPU__ConstPool__TABLE_h5e9b77f5_0[__Vtableidx4];
            ...
            ? ((IData)(vlSelf->CPU__DOT__DCache_inst__DOT__wfsm_en)
                ? (((0xaU == (vlSelf->CPU__DOT__DCache_inst__DOT__addr_pipe 
                    ...
                    ? 2U : (((0xaU == (vlSelf->CPU__DOT__DCache_inst__DOT__addr_pipe 
                                       >> 0x1cU)) & (IData)(vlSelf->CPU__DOT__DCache_inst__DOT__wvalid_pipe))
                             ? 1U : ((1U & (vlSelf->CPU__DOT__DCache_inst__DOT__dirty_table
                                            [(1U & 
                                              ((IData)(vlSelf->CPU__DOT__DCache_inst__DOT__fence_valid_pipe)
...
VL_INLINE_OPT void VCPU___024root___nba_sequent__TOP__0(VCPU___024root* vlSelf) {
    ...
    // Init
    IData/*31:0*/ CPU__DOT__ALU_inst__DOT____VdfgTmp_h837ede85__0;
    CPU__DOT__ALU_inst__DOT____VdfgTmp_h837ede85__0 = 0;
    IData/*31:0*/ CPU__DOT__ALU_inst__DOT____VdfgTmp_h8ce4fc2e__0;
    CPU__DOT__ALU_inst__DOT____VdfgTmp_h8ce4fc2e__0 = 0;
    ...
    if ((1U & ((~ (IData)(vlSelf->rstn)) | (IData)(vlSelf->CPU__DOT__DCache_inst__DOT__dirty_clean_all)))) {
        ...
        __Vdlyvdim0__CPU__DOT__DCache_inst__DOT__dirty_table__v3 
            = (1U & (~ (IData)(vlSelf->CPU__DOT__DCache_inst__DOT____VdfgTmp_ha6ca36fb__0)));
    }
        ...
        if (vlSelf->CPU__DOT__DCache_inst__DOT__lru_hit_update) {
            __Vdly__CPU__DOT__DCache_inst__DOT__lru 
                = (((~ ((IData)(1U) << (IData)(vlSelf->CPU__DOT__DCache_inst__DOT__w_index))) 
                   ...
                   | (0xffffU & ((1U & (~ (IData)(vlSelf->CPU__DOT__DCache_inst__DOT____VdfgTmp_ha6ca36fb__0))) 
                                 << (IData)(vlSelf->CPU__DOT__DCache_inst__DOT__w_index))));
        ...
        if (vlSelf->CPU__DOT__ICache_inst__DOT__lru_hit_update) {
            __Vdly__CPU__DOT__ICache_inst__DOT__lru 
                = (((~ ((IData)(1U) << (0xfU & (vlSelf->CPU__DOT__ICache_inst__DOT__addr_pipe 
                   ...
                   | (0xffffU & ((1U & (~ (IData)(vlSelf->CPU__DOT__ICache_inst__DOT____VdfgTmp_h323f0fa6__0))) 
                                 << (0xfU & (vlSelf->CPU__DOT__ICache_inst__DOT__addr_pipe 
                                             >> 4U)))));
    ...
    vlSelf->CPU__DOT__Branch_inst__DOT____VdfgTmp_h8a52d44e__0 
    ...
    vlSelf->CPU__DOT__Branch_inst__DOT__is_jalr = (
                                                   (~ 
                                                    ((IData)(vlSelf->CPU__DOT__br_type_ex) 
                                                     >> 2U)) 
                                                   & (IData)(vlSelf->CPU__DOT__Branch_inst__DOT____VdfgTmp_h8a52d44e__0));
    if ((0xaU == (vlSelf->CPU__DOT__DCache_inst__DOT__addr_pipe 
                  >> 0x1cU))) {
        vlSelf->wstrb = vlSelf->CPU__DOT__DCache_inst__DOT__wstrb_pipe;
        vlSelf->awlen = 0U;
        vlSelf->awsize = vlSelf->CPU__DOT__DCache_inst__DOT__rsize_pipe;
    } else {
        vlSelf->wstrb = 0xfU;
        vlSelf->awlen = 3U;
        vlSelf->awsize = 2U;
    ...
    vlSelf->CPU__DOT__DCache_inst__DOT____VdfgTmp_ha6ca36fb__0 
    ...
    vlSelf->CPU__DOT__DCache_inst__DOT__hit = (((vlSelf->CPU__DOT__DCache_inst__DOT__valid_bit_rdata
                                                 ...
                                                 & (vlSelf->CPU__DOT__DCache_inst__DOT__tag_mem1__DOT__ram
                                                    ...
                                                    (vlSelf->CPU__DOT__DCache_inst__DOT__addr_pipe 
                                                     >> 8U))) 
                                                << 1U) 
                                               | (IData)(vlSelf->CPU__DOT__DCache_inst__DOT____VdfgTmp_ha6ca36fb__0));
    ...
    vlSelf->CPU__DOT__Decode_inst__DOT____VdfgTmp_haf46db2e__0 
    ...
    vlSelf->CPU__DOT__ALU_inst__DOT____VdfgTmp_h1748fad1__0 
            ...
            if ((1U & (IData)(vlSelf->CPU__DOT__alu_op_ex))) {
                ...
                vlSelf->CPU__DOT__ALU_inst__DOT__result_rem 
                    = ((vlSelf->CPU__DOT__alu_rs1 >> 0x1fU)
                        ...
                        : CPU__DOT__ALU_inst__DOT____VdfgTmp_h8ce4fc2e__0);
                vlSelf->CPU__DOT__ALU_inst__DOT__result_div 
                    = ((IData)(vlSelf->CPU__DOT__ALU_inst__DOT____VdfgTmp_h1748fad1__0)
                        ? (- CPU__DOT__ALU_inst__DOT____VdfgTmp_h837ede85__0)
                        : CPU__DOT__ALU_inst__DOT____VdfgTmp_h837ede85__0);
            }
    ...
    if ((1U & (~ ((IData)(vlSelf->CPU__DOT__axi_arbiter_inst__DOT__r_crt) 
        ...
        if ((2U & (IData)(vlSelf->CPU__DOT__axi_arbiter_inst__DOT__r_crt))) {
            if ((1U & (IData)(vlSelf->CPU__DOT__axi_arbiter_inst__DOT__r_crt))) {
                ...
                vlSelf->arsize = vlSelf->awsize;
                vlSelf->araddr = ((0xaU == (vlSelf->CPU__DOT__DCache_inst__DOT__addr_pipe 
                                            >> 0x1cU))
                                   ? vlSelf->CPU__DOT__DCache_inst__DOT__addr_pipe
                                   : (0xfffffff0U & vlSelf->CPU__DOT__DCache_inst__DOT__addr_pipe));
            }
            if ((1U & (~ (IData)(vlSelf->CPU__DOT__axi_arbiter_inst__DOT__r_crt)))) {
                vlSelf->CPU__DOT__i_rlast = vlSelf->rlast;
                vlSelf->CPU__DOT__i_rready = vlSelf->rvalid;
    ...
    vlSelf->CPU__DOT__ICache_inst__DOT____VdfgTmp_h323f0fa6__0 
        = ((vlSelf->CPU__DOT__ICache_inst__DOT__tag_rdata
                                                ...
                                                & ((vlSelf->CPU__DOT__ICache_inst__DOT__tag_rdata
                                                   ...
                                                   & (((0xffffffU 
                                                       ...
                                                       (vlSelf->CPU__DOT__ICache_inst__DOT__addr_pipe 
                                                        >> 8U)) 
                                                      << 1U))) 
                                               | (IData)(vlSelf->CPU__DOT__ICache_inst__DOT____VdfgTmp_h323f0fa6__0));
    ...
    vlSelf->CPU__DOT__ICache_inst__DOT__req_buf_we 
        = VCPU__ConstPool__TABLE_h9ab258a4_0[__Vtableidx2];
    vlSelf->CPU__DOT__i_rvalid = VCPU__ConstPool__TABLE_h6862c5e6_0
        [__Vtableidx2];
    vlSelf->CPU__DOT__ICache_inst__DOT__tagv_we = VCPU__ConstPool__TABLE_h8015639d_0
        [__Vtableidx2];
    vlSelf->CPU__DOT__ICache_inst__DOT__mem_we = VCPU__ConstPool__TABLE_h8015639d_0
        [__Vtableidx2];
    vlSelf->CPU__DOT__ICache_inst__DOT__data_from_mem 
        = VCPU__ConstPool__TABLE_h3f760619_0[__Vtableidx2];
    vlSelf->CPU__DOT__ICache_inst__DOT__lru_hit_update 
        = VCPU__ConstPool__TABLE_h12e351be_0[__Vtableidx2];
    vlSelf->CPU__DOT__ICache_inst__DOT__lru_refill_update 
        = VCPU__ConstPool__TABLE_h512da660_0[__Vtableidx2];
    vlSelf->CPU__DOT__icache_miss = VCPU__ConstPool__TABLE_h810bd246_0
        [__Vtableidx2];
...
#endif
                VL_FATAL_MT("/home/jyjs/CECS/CECS-Lab/simulator/IP/mycpu/CPU.sv", 3, "", "Input combinational region did not converge.");
            }
...
#endif
                    VL_FATAL_MT("/home/jyjs/CECS/CECS-Lab/simulator/IP/mycpu/CPU.sv", 3, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("/home/jyjs/CECS/CECS-Lab/simulator/IP/mycpu/CPU.sv", 3, "", "NBA region did not converge.");
            }
